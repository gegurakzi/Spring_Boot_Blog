  ...
  <div class="container">
    <form class="needs-validation" novalidate>
      ...
      <div class="form-group p-2">
        ...
        <input type="text" class="form-control" id="title" value="${board.title}" placeholder="" required>
      </div>
      <div class="form-group p-2">
    ...
    <div class="p-2 row">
      ...
      <div class="col-3">
        <button id="btn-update" class="btn btn-primary btn-block" style="width:155px">저장</button>
      </div>
    </div>
  </div>
  <script>
